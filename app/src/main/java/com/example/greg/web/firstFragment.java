...
// the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    ...
    private final String PLUS_ONE_URL = "http://developer.android.com"; // TODO: Rename and change types of parameters
    private String mParam1;
    private String mParam2; private Button b1; private ListView lv;
    private OnFragmentInteractionListener mListener;
    public firstFragment() {
// Required empty public constructor //lv = new ListView(getContext());
    }
    /**
...
//mPlusOneButton = (PlusOneButton) view.findViewById(R.id.plus_one_button);
        b1 = (Button) view.findViewById(R.id.button); b1.setText(mParam1);
...
//Toast.makeText(getContext(), "onDetach Fragment",
     ...
     * fragment to allow an interaction in this fragment to be communicated * to the activity and potentially other fragments contained in that
     * activity.
     */
